...
// Tooltip removed to fix React hooks crash
...
export default function MarketInsightsInfographic() {
  ...
  const StatCard = ({ metric, index }: { metric: MarketMetric; index: number }) => {
    ...
    return (
      ...
      >
              <Card className="relative overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300 border-2 hover:border-blue-200" title={`${neighborhood.name} - ${neighborhood.medianPrice} median price`}>
