  ...
  const defaultNeighborhoods = [
    {
      ...
      name: "Myers Park",
      slug: "myers-park",
      description: "Historic charm with tree-lined streets",
    ...
    },
    {
      ...
      name: "Dilworth",
      slug: "dilworth",
      description: "Trendy area with great dining",
    ...
    },
    {
      ...
      name: "NoDa",
      slug: "noda",
      description: "Arts district with vibrant culture",
    ...
    },
    {
      ...
      name: "South End",
      slug: "south-end",
      description: "Modern high-rises & light rail",
    ...
    },
    {
      ...
      name: "Plaza Midwood",
      slug: "plaza-midwood",
      description: "Eclectic & up-and-coming",
    ...
    <section id="neighborhoods" className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            I specialize in these amazing Charlotte communities, each with its own unique character and charm.
          </p>
        </div>
