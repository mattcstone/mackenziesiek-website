      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-6">
            ...
            <Link href="/" className="stone-black font-normal hover:text-gray-600 transition-colors" style={{fontSize: '1.9rem', lineHeight: '1.2'}}>
              {agentName}
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/sell" className="text-gray-700 hover:text-black transition-colors">
              Sell a Home
            </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              ...
              <Link href="/sell" className="block px-3 py-2 text-gray-700 hover:text-black transition-colors">
                Sell a Home
              </Link>
