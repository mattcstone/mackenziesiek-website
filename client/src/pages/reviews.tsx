        ...
        <section className="py-16 bg-gradient-to-br from-black via-gray-900 to-gray-800">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <div className="inline-flex items-center bg-white/10 rounded-full px-4 py-2 mb-6">
              <span className="text-white font-semibold text-xs uppercase tracking-wider">Verified Reviews</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              What Clients Say About Working With Mackenzie
            </h1>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
              Real voices, real stories — authentic testimonials from clients who experienced the passion and integrity that define Mackenzie's work.
            </p>
          </div>
        </section>

        {/* Reviews Grid */}
        <section id="reviews-grid" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                These authentic testimonials showcase the trust, care, and professionalism Mackenzie brings to every home sale and purchase across the Charlotte area.
              </p>
            </div>
            ...
            <div className="text-center mt-20">
              <div className="bg-gradient-to-r from-black to-gray-900 px-8 py-8 rounded-3xl shadow-2xl inline-flex items-center">
                <div className="flex items-center justify-center flex-1">
                  ...
                  <span className="text-lg font-semibold text-white">Google</span>
                </div>
                <div className="h-16 w-px bg-white/20 mx-6"></div>
                <div className="text-center flex-1">
                  ...
                  <div className="text-gray-300 font-medium">Overall Rating</div>
                </div>
                <div className="h-16 w-px bg-white/20 mx-6"></div>
                <div className="text-center flex-1">
                  <div className="text-3xl font-bold text-white mb-2">542</div>
                  <div className="text-gray-300 font-medium">Reviews</div>
                </div>
              </div>
            </div>
